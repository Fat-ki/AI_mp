...
def load_dataset(train_dir, dev_dir, stemming=False, lower_case=False, silently=True):
    ...
    X0 = loadDir('C:/Users/4508s/PycharmProjects/AI_mp/mp2/'+train_dir + '/pos/',stemming, lower_case, silently)
    X1 = loadDir('C:/Users/4508s/PycharmProjects/AI_mp/mp2/'+train_dir + '/neg/',stemming, lower_case, silently)
    X = X0 + X1
    Y = len(X0) * [1] + len(X1) * [0]

    X_test0 = loadDir('C:/Users/4508s/PycharmProjects/AI_mp/mp2/'+dev_dir + '/pos/',stemming, lower_case,silently)
    X_test1 = loadDir('C:/Users/4508s/PycharmProjects/AI_mp/mp2/'+dev_dir + '/neg/',stemming, lower_case,silently)
